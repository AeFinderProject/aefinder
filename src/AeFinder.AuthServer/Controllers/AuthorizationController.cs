...
public class AuthorizationController : Controller
{
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        var authorizations = await AbpAsyncEnumerableExtensions.ToListAsync(_authorizationManager.FindAsync(
        ...
        switch (await _applicationManager.GetConsentTypeAsync(application))
        {
            ...
            case ConsentTypes.Explicit when authorizations.Any() && !request.HasPrompt(Prompts.Consent):
                ...
                principal.SetResources(await AbpAsyncEnumerableExtensions.ToListAsync(_scopeManager.ListResourcesAsync(principal.GetScopes())));
            ...
            // In every other case, return forbid.
            default:
                return GetForbidResult(OpenIddictConstants.Errors.InvalidRequest, "access deny");
        }
    }
