...
public class BlockChainDataEventProcessor: IBlockChainDataEventProcessor, ITransientDependency
{
    private readonly ILogger<BlockChainDataEventProcessor> _logger;
    ...
    public BlockChainDataEventProcessor(
        ILogger<BlockChainDataEventProcessor> logger,
        IObjectMapper objectMapper,
        IBlockGrainProvider blockGrainProvider,
        IBlockSyncAppService blockSyncAppService)
    {
        _logger = logger;
    ...
    public async Task HandleEventAsync(BlockChainDataEto eventData)
    {
        ...
        _logger.LogInformation(
            "Received BlockChainDataEto form {ChainId}, start block: {StartBlockHeight}, end block: {EndBlockHeight}",
            eventData.ChainId, eventData.Blocks.First().BlockHeight, lastBlockHeight);
