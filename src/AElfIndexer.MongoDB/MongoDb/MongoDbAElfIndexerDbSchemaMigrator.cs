...
public class MongoDbAElfIndexerDbSchemaMigrator : IAElfIndexerDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAElfIndexerDbSchemaMigrator(IServiceProvider serviceProvider)
    {
