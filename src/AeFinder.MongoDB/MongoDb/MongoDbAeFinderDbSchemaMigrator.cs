...
public class MongoDbAeFinderDbSchemaMigrator : IAeFinderDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAeFinderDbSchemaMigrator(IServiceProvider serviceProvider)
    {
