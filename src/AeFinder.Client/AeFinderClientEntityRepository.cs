...
public class AeFinderClientEntityRepository<TEntity,TData> : IAeFinderClientEntityRepository<TEntity,TData>
    ...
    where TData : BlockChainDataBase
{
    ...
    public AeFinderClientEntityRepository(INESTRepository<TEntity, string> nestRepository,
        ...
        IBlockStateSetProvider<TData> blockStateSetProvider, IDAppDataIndexProvider<TEntity> dAppDataIndexProvider)
    {
        ...
        _clientInfoProvider = aefinderClientInfoProvider;

        _entityName = typeof(TEntity).Name;
        // _clientId = aefinderClientInfoProvider.GetClientId();
        // _version = aefinderClientInfoProvider.GetVersion();
