...
public class MockDataHelper
{
    ...
    public static NewBlockEto MockNewBlockEtoData(long blockNumber, string previousBlockHash)
    {
    ...
    public static NewBlockEto MockNewBlockEtoData(string blockHash,long blockNumber, string previousBlockHash)
    {
    ...
    public static ConfirmBlockEto MockConfirmBlockEtoData(string blockHash,long blockNumber)
    {
