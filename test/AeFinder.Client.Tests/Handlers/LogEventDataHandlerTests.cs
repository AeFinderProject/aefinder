...
public class LogEventDataHandlerTests : AeFinderClientLogEventHandlerTestBase
{
    ...
    private readonly IAeFinderClientEntityRepository<TestTransferredIndex, LogEventInfo> _repository;
    ...
    public LogEventDataHandlerTests()
    {
        ...
        _repository = GetRequiredService<IAeFinderClientEntityRepository<TestTransferredIndex, LogEventInfo>>();
