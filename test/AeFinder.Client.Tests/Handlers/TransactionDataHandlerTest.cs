...
public class TransactionDataHandlerTest : AeFinderClientTransactionDataHandlerTestBase
{
    ...
    private readonly IAeFinderClientEntityRepository<TestBlockIndex, BlockInfo> _blockRepository;
    ...
    public TransactionDataHandlerTest()
    {
        ...
        _repository = GetRequiredService<IAeFinderClientEntityRepository<TestTransactionIndex, TransactionInfo>>();
        _transferredRepository =
            GetRequiredService<IAeFinderClientEntityRepository<TestTransferredIndex, LogEventInfo>>();
