...
public class BlockHandlerTests : AeFinderClientBlockDataHandlerTestBase
{
    ...
    public BlockHandlerTests()
    {
        ...
        _repository = GetRequiredService<IAeFinderClientEntityRepository<TestBlockIndex, BlockInfo>>();
