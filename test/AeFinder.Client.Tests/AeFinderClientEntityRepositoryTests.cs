...
public class AeFinderClientEntityRepositoryTests : AeFinderClientTestBase
{
    private readonly IAeFinderClientEntityRepository<TestIndex, BlockInfo> _clientEntityRepository;
    ...
    public AeFinderClientEntityRepositoryTests()
    {
        _clientEntityRepository = GetRequiredService<IAeFinderClientEntityRepository<TestIndex, BlockInfo>>();
