...
namespace AElfIndexer.BlockChainEventHandler.Core.Tests.AElf;

[Collection(ClusterCollection.Name)]
public sealed class BlockChainDataEventHandlerTests:AElfIndexerBlockChainEventHandlerCoreTestBase
{
    ...
    {
        string chainId = "TEST";
        var primaryKeyGrain = Cluster.Client.GetGrain<IPrimaryKeyGrain>(GrainIdHelper.GenerateGrainId(chainId,AElfIndexerApplicationConsts.PrimaryKeyGrainIdSuffix));
